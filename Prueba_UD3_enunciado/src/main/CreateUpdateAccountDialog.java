			...
			public void actionPerformed(ActionEvent e) {
				if (!(textFieldAmount.getText().trim().equals(""))) {
					try {
						...
						//Añado esta parte de codigo al codigo original proporcionado - para intentar solucionar el problema con el metodo
						//Si la cuenta no existia, se crea una nueva instancia
//						if (cuentaACrearOActualizar == null) {
//							cuentaACrearOActualizar = new Account();
//						}						
						//y a continuacion añade la cantidad
